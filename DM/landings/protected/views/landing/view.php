...
if(isset($_POST['submit']) && $_POST['submit']==1){
	$url_pais = "&p=".$_POST['pais'];
	$url_font = "&font=".$_POST['fuente'];
	$link="";
	$link = "page.php?id=".$model->id.$url_pais.$url_font;
...
<form method="post">
	...
	Fuente:<select name="fuente">
		...
		<option value="NL">Newsletter</option>
		<option value="PV">Proveedores</option>
	</select>
