...
<div class="view">
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('id_inmobiliaria')); ?>:</b>
	<?php echo CHtml::encode($data->id_inmobiliaria); ?>
	<br />
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('name_inmobiliaria')); ?>:</b>
	<?php echo CHtml::encode($data->name_inmobiliaria); ?>
	<br />
